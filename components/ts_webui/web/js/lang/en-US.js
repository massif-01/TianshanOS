...
if (typeof i18n !== 'undefined') i18n.registerLanguage('en-US', {
    promptRepair: {
        taskResults: 'Configuration task history',
        taskAttempt: 'Attempt {attempt}: {path}',
        retry: 'Retry',
        pageLoadFailed: 'The page could not be loaded. Please retry.',
        logoutConfirmed: "Signed out locally. The server acknowledged the sign-out request.",
        logoutLocal: "Local sign-in information was cleared. The server session has not been confirmed as ended.",
        packRevalidate: "This package verification is no longer current. Upload and verify it again.",
        listRefreshFailed: "The file list could not be refreshed. Refresh it manually. Confirmed upload results are unchanged.",

        "phase_PLATFORM": "Platform initialization",
        "phase_CORE": "Core services",
        "phase_HAL": "Hardware access",
        "phase_DRIVER": "Device drivers",
        "phase_NETWORK": "Network services",
        "phase_SECURITY": "Security services",
        "phase_SERVICE": "Application services",
        "phase_UI": "User interface",
        ...
        "state_Blocked": "Waiting for a resource or event",
        "state_Suspended": "Suspended",
        "state_Deleted": "Deleted",

        "settingsTitle": "{device} · Settings",
        "viewVariables": "View variables: {name}.*",
        "ledServiceStatus": "Check LED service status",
        "customColor": "Custom color",
        "organization": "Organization",
        "wwwPartial": "Firmware was written, but the WebUI upgrade failed; no restart was requested.",
        "wwwRetry": "Retry WebUI upgrade",
        "variableCount": "{count} variables",
        "variableExample": "Example: system.flag",
        "valueExample": "Examples: true, 123, ${other_var}",
        "webhookConfig": "Webhook settings",
        "qrVariableHint": "Text or URL; supports ${variable_name}",
        "noHosts": "No hosts available. Add a host on the SSH page first.",
        "noCommands": "This host has no commands. Add one on the SSH page first.",
        "chooseCommand": "Select a command",
        "chooseAction": "Select an action template",
        ...
        "packGenerated": "Configuration package generated\nFile: {name}\nSize: {size} bytes; contains {count} configuration files",
        "orphanCount": "The hosts referenced by {count} commands no longer exist",
        "orphanHost": "Host “{id}” does not exist. Select another host for this command or delete the command.",
        "expectedLabel": "Expected output:",
        "failureLabel": "Failure condition:",
        "extractLabel": "Extraction rule:",
        "servicePattern": "Service readiness condition: {pattern}",
        "waitEvent": "Connecting and waiting for event: {event}",
        "event": "Event",
        "noEvent": "A session was established, but no event data was received.",
        "outputPreview": "Output: {output}",
        "upgradeWritten": "Upgrade files were written. Requesting a device restart.",
        "rebootUnknown": "Restart confirmation was not received. The device may be restarting; wait for the status check before repeating the operation.",
        ...
        "effect_heartbeat": "Heartbeat",
        "effect_chase": "Chase",
        "effect_comet": "Comet",
        "effect_spin": "Spin",
        "effect_breathe_wave": "Breathing wave",
        "effect_fire": "Fire",
        "effect_rain": "Rain",
        "effect_coderain": "Code rain",
        "effect_plasma": "Plasma",
        "effect_ripple": "Ripple",
        "effect_unknown": "Unknown animation",

        "sshAccepted": "The device accepted the execution request. Process startup and readiness are not yet confirmed.\n\n",
        "sshCheckOutput": "Use the buttons above to check logs or process status.\n",
        "sshBegin": "--- Execution started ---\n",
        "sshEnd": "\n--- Execution ended ---\n",
        "sshCancelOutput": "\nCancellation handling finished; remote command termination is not confirmed.\n",
        "noOutput": "(No output)\n",
        "serviceStoppedOutput": "The service has stopped.\n",
        "processStoppedOutput": "The process has stopped.\n",
        "tailStopped": "\nLive log tracking stopped.\n",
        "matchSettings": "\nOutput matching settings:\n",
        "stopOnMatch": "  Stop after a match: yes\n",
        "modeFailed": "The fan mode could not be changed.",
        "noResponse": "No response data was received.",
        "enterOtaPath": "Enter the path to the firmware file or its folder.",
        "otaPathFailed": "The SD card upgrade file could not be read. Check its path.",
        "wwwSibling": "Check that www.bin is in the same folder as the firmware file.",
        "startFailed": "The operation could not be started.",
        "webUploadFailed": "The WebUI file could not be uploaded.",
        "firmwareDownloading": "Downloading firmware…",
        "firmwareStep": "[1/2] Firmware ",
        "webUpgradeFailed": "WebUI upgrade incomplete: ",
        "hiddenPrefix": "[Hidden] ",
        "officialSuffix": " (Official)",
        "logFile": "Log file: {path}\n",
        "logFileSpaced": "\nLog file: {path}\n",
        "processKeyword": "Process keyword: {keyword}\n",
        "sessionWaiting": "Session ID: {id}\nWaiting for output…\n\n",
        "expectedPattern": "  Expected output pattern: {pattern}\n",
        "failurePattern": "  Failure output pattern: {pattern}\n",
        "extractPattern": "  Extraction pattern: {pattern}\n",
        "storedVariable": "  Store in variable: {name}.*\n",
        "exitCode": "Exit code: {code}\n",
        "extractedLine": "Extracted content: {value}\n",
        "extractedBlock": "\nExtracted content:\n{value}\n",
        "sshError": "\nExecution error: {message}\n",
        "executionFailed": "Execution did not complete: {message}\n",
        "stopFailed": "The service could not be confirmed stopped: {message}",
        "firmwareMissing": "Firmware file not found: {path}",
        "wwwMissing": "WebUI file not found: {path}",
        "directoryUnreadable": "Folder could not be read: {path}",
        "firmwareDirMissing": "No firmware .bin file was found in: {path}",
        "wwwDirMissing": "WebUI file not found: {path}/www.bin",
        "dnsFailed": "The device could not resolve the server address: {host}",
        "tcpFailed": "The device could not connect to the server: {host}:{port}",
        "httpFailed": "The device could not retrieve content from the server: {message}",
        "httpStatus": "The server returned an error (HTTP {status}).",
        "downloadHttpStatus": "Download failed (HTTP {status}).",
        "sshStopping": "The process is still running. Requesting forced termination…\n",
        "stopUnconfirmed": "Forced termination was requested, but the process state is unconfirmed. Check its status.",
        "credentials": "The username or password is incorrect.",
        "oldPassword": "The current password is incorrect. Enter it again.",
        "sdUnavailable": "The SD card is not available. Check that it is inserted and mounted.",
        "sdMounted": "The SD card is already mounted.",
        "fileMissing": "This file could not be found. Refresh the file list.",
        "directoryMissing": "This folder could not be found. Refresh the file list.",
        "rootDirectory": "The storage root cannot be deleted. Select a file or folder inside it.",
        "fileInfo": "File information could not be read. Check the storage device and refresh the list.",
        "unknownError": "The operation could not be completed. See the details below.",
        "invalidInput": "The submitted information is not valid. Check the relevant settings.",
        "notFound": "The requested item could not be found. Refresh the list to check whether it still exists.",
        "permission": "Your account does not have permission to perform this operation.",
        "busy": "The device is busy. Wait for the current operation to finish.",
        "timeout": "A complete response was not received in time. The result is unconfirmed; check the current state first.",
        "resultUnknown": "No complete confirmation was received. The result is unknown. Check the current state before repeating the operation.",
        "memory": "The device does not have enough available memory to complete the operation.",
        "internal": "The device encountered an error while processing the request. See the details below.",
        "unsupported": "This operation is not supported by this device.",
        "hardware": "The hardware operation could not be completed. Check the relevant hardware status.",
        "connection": "The device or target service could not be reached. Check the network connection.",
        "auth": "Authentication failed. Check your credentials or sign in again.",
        "invalidResponse": "The device response could not be read. The result is unconfirmed.",
        "details": "Details: {detail}",
        "deleteSummary": "Deletion results: {success} succeeded; {fail} failed or are unconfirmed.",
        "downloadSummary": "Downloads requested in the browser: {success}; not started: {fail}. Check the browser for saved files.",
        "uploadSummary": "Upload results: {success} uploaded; {fail} failed or unconfirmed; {invalid} configuration packages failed verification. Uploading does not apply a configuration.",
        "ledSummary": "Lights switched off: {success}; failed or unconfirmed: {fail}.",
        "uploaded": "The file has been uploaded.",
        "packVerified": "Uploaded and signature verified; not yet applied.",
        "packInvalid": "The file was uploaded, but package verification failed. It cannot be applied.",
        "downloadStarted": "The download has been requested in the browser. Check the browser for the saved file.",
        "hiddenNetwork": "Hidden network",
        "wifiPassword": "Enter the password for “{ssid}”; leave it blank for an open network:",
        "logConnected": "Live log connection established",
        "logDisconnected": "Live logs disconnected; waiting to reconnect",
        "sshSubmissionUnknown": "Command acceptance was not confirmed. Check the logs or process status before submitting it again.",
        "sshDiagnostics": "Reported status: {status}; exit code: {code}",
        "sshUnknown": "The command result is unconfirmed. Check the output and status details.",
        "sshTimeout": "The command timed out. Check the output to see what was executed.",
        "sshCancelled": "Cancellation handling finished; remote command termination is not confirmed.",
        "sshFailureOutput": "The output matched a configured failure condition. Check the command output.",
        "sshExpectedMissing": "The command ended without the expected output.",
        "sshExpectedFound": "The expected output was detected. Waiting for the final result.",
        "sshFailed": "The command failed. Check its output and exit code.",
        "sshSuccess": "The command completed successfully.",
        "lpmuProbeFailed": "The LPMU network check failed. Its power state is unknown.",
        "lpmuReachable": "LPMU is reachable over the network. This check does not confirm its power state.",
        "lpmuUnreachable": "LPMU is unreachable over the network. This does not confirm that it is powered off.",
        "retry": "Retry",
        "terminalLoadFailed": "Terminal components could not be loaded. Check the network and retry.",
        "terminalRestoring": "Restoring the terminal session. Waiting for connection confirmation.",
        "terminalRestored": "The terminal session has been restored. Previous commands were not resent.",
        "terminalRestoreTimeout": "Terminal session recovery timed out. Connection is unconfirmed.",
        "terminalRestoreFailed": "The terminal session could not be restored. Reconnect to continue.",
        "noInitialColor": "No initial color configuration is available to restore.",
        ...
        "ruleCreated": "Rule “{id}” created successfully.",
        "ruleUpdated": "Rule “{id}” updated successfully."
},
    ...
    runtimeRepair: {
        ...
        saved: 'Saved',
        "showDashboard": "Show on dashboard",
        "allowManual": "Allow manual execution",
        "conditionsPreserved": "Manual mode preserves conditions; automatic evaluation resumes on the next cycle.",
        "saveFailed": "Save failed; draft retained",
        "saveUnknown": "Save outcome unknown. Read back before resubmitting.",
        "mirrorWarning": "Saved, but backup is not synchronized. Keep the SD card installed.",
        "revision_conflict": "Configuration changed. Reload and merge your draft.",
        "source_read_only": "This configuration source is read-only; original retained.",
        "recovery_required": "Configuration recovery is required; automatic execution paused.",
        "commit_unknown": "Save outcome unknown; recovery required.",
        "execution_busy": "Rule is executing; operation unavailable.",
        "service_busy": "Service is active or unconfirmed. Verify and stop it first.",
        "busy_retired_config": "Previous configuration is still in use; retry later.",
        "disabled": "Disabled",
        "manual": "Manual",
        "automatic": "Automatic",
        "referenceUnresolved": "Unresolved reference",
        "unknown": "Unconfirmed",
        "running": "Process running",
        "ready": "Readiness log matched",
        "checking": "Checking readiness log",
        "starting": "Starting",
        "stopping": "Stopping",
        "stopped": "Process confirmed stopped",
        "failed": "Failure log matched",
        "timeout": "Readiness check timed out",
        "lastKnown": "Last known",
        "confirmedAt": "Last confirmation (uptime)",
        "stateEvidence": "Evidence source",
        "startBlocked": "Start unavailable: check enablement, manual permission and service state.",
        "outcomeUnknown": "Remote outcome unknown; it may still be running. Verify before retrying.",
        "confirmStop": "Stop the remote service?",
        "confirmStopAutomatic": "Stop the remote service? An enabled automatic rule may start it on the next matching evaluation. Disable the rule to keep it stopped.",
        "refresh_required": "Refresh this outdated page before editing."
},
    ...
    system: {
        ...
        lpmuDetecting: "Check result unknown",
        usbMux: 'USB Switch',
        ...
        lpmuRunning: "Network reachable",
        lpmuStopped: "Network unreachable",
        lpmuOnlineTitle: "LPMU is reachable over the network. This check does not confirm its power state.",
        lpmuOfflineTitle: "LPMU is unreachable over the network. This does not confirm that it is powered off.",
        lpmuDetectingTitle: 'Detecting LPMU status...\nWait up to 80 seconds',
        lpmuUnknownTitle: "The LPMU network check failed. Its power state is unknown.",
        ...
        lpmuOnlineSuccess: "LPMU is reachable over the network. This check does not confirm its power state.",
        lpmuOfflineSuccess: "LPMU is unreachable over the network. This does not confirm that it is powered off.",
        lpmuStartupTimeout: "LPMU is unreachable over the network. This does not confirm that it is powered off.",
        lpmuShutdownTimeout: "LPMU is reachable over the network. This check does not confirm its power state."
    },
    ...
    ssh: {
        ...
        includeHostConfigHint: "Include this to import the complete configuration on the target device.",
        serviceModeVarHint: "Service status is stored in <code>${变量名}.status</code> (ready/checking/timeout).",
        timeoutConditionHint: "The timeout applies only when a success or failure pattern is set, or “Stop on match” is enabled.",
        matchTimeoutHint: "The command will be terminated when the matching timeout is reached.",
        hostNotExistCannotExec: "This host no longer exists. Select another host before running the command.",
        title: 'SSH Commands',
        hosts: 'Hosts',
        commands: 'Commands',
    ...
    automation: {
        ...
        selectLedDeviceHint: "Select the LED device to control.",
        ledConfig: "LED control settings",
        variableLabel: "Variable:",
        sshCmdHint: "Select a command configured on the SSH management page.",
        sshCmdConfig: "SSH command settings",
        resultVariableHint: "Store command output in this variable.",
        fan: "Fan",
        agxRestart: "Restart AGX",
        cliPlaceholder: "e.g.: gpio --set 48 1",
        cliConfig: "Console command settings",
        ...
        exportActionDesc: 'Export the configuration for action {actionId} as an encrypted package',
    ...
    toast: {
        ...
        lowVoltageWarning: "Input voltage is low: {voltage} V. Shutdown countdown: {countdown} seconds.",
        ...
        nohupStripped: "Duplicate background execution parameters were removed. The system will run this command in the background.",
        ...
        commandCompletedCode: "The command did not complete successfully (exit code: {code}). Check its output.",
        execError: 'Execution error',
        execErrorMsg: 'Execution error: {msg}',
        commandCancelled: 'Cancellation handled; remote outcome unconfirmed',
        hostFingerprintDeleted: 'Host fingerprint deleted',
        hostInfoEmpty: "No connection settings are available for this host. Check its settings.",
    ...
    networkPage: {
        ...
        lpmuAccessTitle: 'Upstream Network Access',
        lpmuAccessButton: 'Access via LPMU',
        lpmuAccessIdle: 'Not started',
        lpmuAccessRunning: 'Processing',
        lpmuAccessStageCheck: 'Checking remote project',
        lpmuAccessStageUpload: 'Uploading project package',
        lpmuAccessStageUnpack: 'Extracting project',
        lpmuAccessStageExecute: 'Running route script',
        lpmuAccessSuccess: 'Success',
        lpmuAccessFailed: 'Failed',
        lpmuAccessError: 'Error',
        lpmuAccessOutput: 'Output',
        lpmuAccessStartFailed: 'Failed to start access',
        lpmuAccessStatusFailed: 'Failed to fetch status',
        clients: 'Clients',
        // Panel titles
    ...
    sshPage: {
        ...
        deployKeyAtSecurityHint: 'Please go to <a href="#/security">Security</a> page to deploy SSH public key first',
        ...
        failMatchedTrue: "A failure condition was detected",
        failMatchedFalse: "No failure condition was detected",
    ...
    securityPage: {
        ...
        confirmAdminPasswordPlaceholder: 'Enter the new password again',
        showPassword: 'Show password',
        hidePassword: 'Hide password',
        setAdminPassword: 'Set admin password',
        dangerZone: 'Danger Zone',
        resetAdminPasswordDesc: 'Reset admin to the default password rm01 and clear login lockout state.',
        resetAdminPassword: 'Reset admin to default',
        adminPasswordMismatch: 'The two admin passwords do not match',
        adminPasswordLength: 'Admin password must be 4-64 characters',
        adminPasswordSetSuccess: 'Admin password updated',
        adminPasswordResetSuccess: 'Admin password reset to default rm01',
        confirmResetAdminPassword: 'Reset admin password?\n\nThis will restore admin to the default password rm01 and clear login lockout state.',
        // Certificate details
    ...
    fanPage: {
        ...
        hysteresisRangeError: "The temperature change required to adjust fan speed (hysteresis) must be 0–20°C.",
        intervalRangeError: "The minimum time between fan speed adjustments must be 0.5–30 seconds.",
    ...
    pkiRepair: {
        ...
        "time_unverified": "Validity: awaiting device time",
        "not_yet_valid": "Validity: not yet valid",
        "valid": "Within validity period",
        "expired": "Validity: expired",
        "stored": "Saved",
        "missing": "Missing",
        "key": "Private key",
        "certificate": "Device certificate",
        "clientCa": "Client verification CA",
        "running": "Running",
        "stopped": "Not running",
        "restart": "Stored materials changed. The running service still uses the previous materials. Restart the device to apply; startup conditions must be met. Deleting stored credentials does not revoke the active instance.",
        "activeFingerprint": "Active certificate SHA-256",
        "deviceTime": "Device time",
        "synced": "Synchronized",
        "unsynced": "Not synchronized",
        "timeUnknown": "Device time unavailable; retry refresh",
        "syncBrowser": "Set device time from this computer (browser source)",
        "empty": "Provide PEM text",
        "saved": "Saved. Check validity and actual HTTPS status.",
        "unconfirmed": "Installation result unconfirmed. Refresh status to check before retrying.",
        "lessDay": "Expires in less than a day",
        "expiredLessDay": "Expired less than a day ago",
        "block_time_not_ready": "Device time not ready",
        "block_private_key_missing": "Private key missing",
        "block_private_key_invalid": "Private key invalid",
        "block_certificate_missing": "Certificate missing",
        "block_certificate_invalid": "Certificate invalid",
        "block_key_mismatch": "Key mismatch",
        "block_not_yet_valid": "Not yet valid",
        "block_expired": "Expired",
        "block_ca_missing": "Client verification CA missing",
        "block_ca_invalid": "Client verification CA invalid",
        "block_storage_error": "Storage uncertain; restart and check materials"
},
    pkiPage: {
        signatureVerified: 'Signature verified',
    ...
    ui: {
        ...
        confirmDeleteFiles: "Delete the selected {count} files or folders? This cannot be undone.",
        // Language
        chinese: '中文',
        english: 'EN',
