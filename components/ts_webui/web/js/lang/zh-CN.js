...
if (typeof i18n !== 'undefined') i18n.registerLanguage('zh-CN', {
    promptRepair: {
        taskResults: '配置应用任务记录',
        taskAttempt: '第 {attempt} 次：{path}',
        retry: '重试',
        pageLoadFailed: '页面加载失败，请重试。',
        logoutConfirmed: "已在本地退出，服务端已响应退出请求。",
        logoutLocal: "已清除本地登录信息，尚未确认服务端会话已结束。",
        packRevalidate: "此配置包的验证结果已失效，请重新上传并验证。",
        listRefreshFailed: "文件列表刷新失败，请手动刷新。已确认的上传结果不受影响。",

        "phase_PLATFORM": "平台初始化",
        "phase_CORE": "核心服务",
        "phase_HAL": "硬件访问层",
        "phase_DRIVER": "设备驱动",
        "phase_NETWORK": "网络服务",
        ...
        "state_Running": "正在执行",
        "state_Ready": "等待调度",
        "state_Blocked": "等待资源或事件",
        "state_Suspended": "已挂起",
        "state_Deleted": "已删除",

        "settingsTitle": "{device} · 设置",
        "viewVariables": "查看变量：{name}.*",
        "ledServiceStatus": "检查 LED 服务状态",
        "customColor": "自定义颜色",
        "organization": "组织",
        "wwwPartial": "固件已写入，但 WebUI 升级失败；尚未请求重启。",
        "wwwRetry": "重试 WebUI 升级",
        "variableCount": "{count} 个变量",
        "variableExample": "例如：system.flag",
        "valueExample": "例如：true、123、${other_var}",
        "webhookConfig": "Webhook 配置",
        "qrVariableHint": "文本或网址，支持 ${变量名}",
        "noHosts": "暂无主机，请先在 SSH 页面添加。",
        "noCommands": "该主机暂无命令，请在 SSH 页面添加。",
        "chooseCommand": "请选择命令",
        "chooseAction": "请选择动作模板",
        "unknownFilter": "未知滤镜",
        "colorRed": "红",
        "colorOrange": "橙",
        "colorYellow": "黄",
        ...
        "packGenerated": "配置包已生成\n文件：{name}\n大小：{size} 字节；包含 {count} 个配置文件",
        "orphanCount": "{count} 个命令关联的主机已不存在",
        "orphanHost": "主机“{id}”不存在，请为命令重新选择主机或删除命令。",
        "expectedLabel": "预期输出：",
        "failureLabel": "失败条件：",
        "extractLabel": "提取规则：",
        "servicePattern": "服务就绪条件：{pattern}",
        "waitEvent": "正在连接，等待事件：{event}",
        "event": "事件",
        "noEvent": "已建立会话，但未收到事件数据。",
        "outputPreview": "输出：{output}",
        "upgradeWritten": "升级文件已写入，正在请求设备重启。",
        "rebootUnknown": "未收到重启确认。设备可能正在重启，请等待状态检查，不要重复操作。",
        "horizontal": "横向",
        "vertical": "纵向",
        "diagonalRight": "对角 ↘",
        "diagonalLeft": "对角 ↙",
        ...
        "effect_sparkle": "闪烁",
        "effect_pulse": "脉冲",
        "effect_color_cycle": "颜色循环",
        "effect_heartbeat": "心跳",
        "effect_chase": "追逐",
        "effect_comet": "彗星",
        "effect_spin": "旋转",
        "effect_breathe_wave": "呼吸波",
        "effect_fire": "火焰",
        "effect_rain": "雨滴",
        "effect_coderain": "代码雨",
        "effect_plasma": "等离子",
        ...
        "sshAccepted": "设备已受理执行请求，进程启动与就绪状态尚待确认。\n\n",
        "sshCheckOutput": "请使用上方按钮查看日志或进程状态。\n",
        "sshBegin": "--- 开始执行 ---\n",
        "sshEnd": "\n--- 执行结束 ---\n",
        "sshCancelOutput": "\n取消处理已结束；远端命令是否终止尚未确认。\n",
        "noOutput": "（无输出）\n",
        "serviceStoppedOutput": "服务已停止。\n",
        "processStoppedOutput": "进程已停止。\n",
        "tailStopped": "\n已停止实时跟踪。\n",
        "matchSettings": "\n输出匹配设置：\n",
        "stopOnMatch": "  检测到匹配后停止：是\n",
        "modeFailed": "未能切换风扇模式。",
        "noResponse": "未收到响应数据。",
        "enterOtaPath": "请输入固件文件或所在目录的路径。",
        "otaPathFailed": "无法读取 SD 卡升级文件，请检查文件路径。",
        "wwwSibling": "请确认 www.bin 与固件文件位于同一目录。",
        "startFailed": "未能启动操作。",
        "webUploadFailed": "WebUI 文件上传失败。",
        "firmwareDownloading": "正在下载固件…",
        "firmwareStep": "[1/2] 固件 ",
        "webUpgradeFailed": "WebUI 升级未完成：",
        "hiddenPrefix": "[隐藏] ",
        "officialSuffix": "（官方）",
        "logFile": "日志文件：{path}\n",
        "logFileSpaced": "\n日志文件：{path}\n",
        "processKeyword": "进程关键词：{keyword}\n",
        "sessionWaiting": "会话 ID：{id}\n正在等待输出…\n\n",
        "expectedPattern": "  预期输出匹配：{pattern}\n",
        "failurePattern": "  失败输出匹配：{pattern}\n",
        "extractPattern": "  内容提取匹配：{pattern}\n",
        "storedVariable": "  保存到变量：{name}.*\n",
        "exitCode": "退出码：{code}\n",
        "extractedLine": "提取内容：{value}\n",
        "extractedBlock": "\n提取内容：\n{value}\n",
        "sshError": "\n执行错误：{message}\n",
        "executionFailed": "执行未完成：{message}\n",
        "stopFailed": "未能确认服务已停止：{message}",
        "firmwareMissing": "找不到固件文件：{path}",
        "wwwMissing": "找不到 WebUI 文件：{path}",
        "directoryUnreadable": "无法读取文件夹：{path}",
        "firmwareDirMissing": "文件夹中没有固件 .bin 文件：{path}",
        "wwwDirMissing": "找不到 WebUI 文件：{path}/www.bin",
        "dnsFailed": "设备无法解析服务器地址：{host}",
        "tcpFailed": "设备无法连接到服务器：{host}:{port}",
        "httpFailed": "设备未能从服务器获取内容：{message}",
        "httpStatus": "服务器返回错误（HTTP {status}）。",
        "downloadHttpStatus": "下载失败（HTTP {status}）。",
        "sshStopping": "进程仍在运行，正在请求强制停止…\n",
        "stopUnconfirmed": "已发送强制停止请求，进程是否停止尚未确认。请检查进程状态。",
        "credentials": "用户名或密码错误。",
        "oldPassword": "当前密码错误，请重新输入。",
        "sdUnavailable": "SD 卡尚未就绪，请检查插卡和挂载状态。",
        "sdMounted": "SD 卡已经可以使用，无需重复挂载。",
        "fileMissing": "找不到这个文件，请刷新文件列表。",
        "directoryMissing": "找不到这个文件夹，请刷新文件列表。",
        "rootDirectory": "不能删除存储根目录，请选择其中的文件或文件夹。",
        "fileInfo": "无法读取文件信息。请检查存储设备后刷新列表。",
        "unknownError": "操作未能完成。请查看详细原因。",
        "invalidInput": "提交的信息不符合要求，请检查相关设置。",
        "notFound": "找不到所需项目，请刷新列表检查它是否仍然存在。",
        "permission": "当前账户没有执行此操作的权限。",
        "busy": "设备正在处理其他操作，请等待当前操作结束。",
        "timeout": "未在规定时间内收到完整响应，无法确认结果。请先检查当前状态。",
        "resultUnknown": "未收到完整确认，操作结果未知。请先检查当前状态，不要重复执行。",
        "memory": "设备可用内存不足，暂时无法完成操作。",
        "internal": "设备处理请求时发生错误，请查看详细原因。",
        "unsupported": "当前设备不支持此操作。",
        "hardware": "设备未能完成硬件操作，请检查相关硬件状态。",
        "connection": "无法连接到设备或目标服务，请检查网络连接。",
        "auth": "身份验证未通过，请检查登录信息或重新登录。",
        "invalidResponse": "设备返回的内容无法识别，操作结果未确认。",
        "details": "详细原因：{detail}",
        "deleteSummary": "删除结果：{success} 项成功，{fail} 项失败或未确认。",
        "downloadSummary": "已向浏览器发起 {success} 项下载，{fail} 项未能发起。请在浏览器中确认保存结果。",
        "uploadSummary": "上传结果：{success} 项已上传，{fail} 项失败或未确认；{invalid} 个配置包未通过验证。上传不代表配置已应用。",
        "ledSummary": "关闭灯光结果：{success} 项成功，{fail} 项失败或未确认。",
        "uploaded": "文件已上传。",
        "packVerified": "已上传，签名验证通过；尚未应用。",
        "packInvalid": "文件已上传，但配置包验证未通过，不能应用。",
        "downloadStarted": "已向浏览器发起下载，请在浏览器中确认保存结果。",
        "hiddenNetwork": "隐藏网络",
        "wifiPassword": "请输入“{ssid}”的密码；开放网络可留空：",
        "logConnected": "实时日志连接已建立",
        "logDisconnected": "实时日志连接已断开，等待重新连接",
        "sshSubmissionUnknown": "未收到命令受理确认，无法确定是否已经提交。请查看日志或进程状态，不要直接重复执行。",
        "sshDiagnostics": "返回状态：{status}；退出码：{code}",
        "sshUnknown": "无法确认命令结果，请查看输出和状态详情。",
        "sshTimeout": "命令执行超时，请查看输出确认实际执行情况。",
        "sshCancelled": "取消处理已结束；远端命令是否终止尚未确认。",
        "sshFailureOutput": "命令输出命中了配置的失败条件，请查看输出。",
        "sshExpectedMissing": "命令已结束，但未检测到配置的预期输出。",
        "sshExpectedFound": "已检测到预期输出，等待最终执行结果。",
        "sshFailed": "命令执行失败，请查看输出和退出码。",
        "sshSuccess": "命令执行成功。",
        "lpmuProbeFailed": "LPMU 网络检测失败，电源状态未知。",
        "lpmuReachable": "LPMU 网络可达；此检测不能确认电源状态。",
        "lpmuUnreachable": "LPMU 网络不可达，无法据此确认是否已关机。",
        "retry": "重试",
        "terminalLoadFailed": "终端组件加载失败。请检查网络后重试。",
        "terminalRestoring": "正在恢复终端会话，请等待连接确认。",
        "terminalRestored": "终端会话已恢复；之前的命令未自动重发。",
        "terminalRestoreTimeout": "终端会话恢复超时，尚未确认连接。",
        "terminalRestoreFailed": "终端会话未能恢复，请重新连接。",
        "noInitialColor": "没有可恢复的初始颜色配置。",
        "serviceStarted": "服务“{name}”已启动。",
        "serviceStopped": "服务“{name}”已停止。",
        "serviceRestarted": "服务“{name}”已重启。",
        "ruleCreated": "规则“{id}”已创建。",
        "ruleUpdated": "规则“{id}”已更新。"
},
    ...
    runtimeRepair: {
        ...
        "showDashboard": "在首页显示",
        "allowManual": "允许手动执行",
        "conditionsPreserved": "手动模式保留自动条件，切回自动后从下一次评估开始生效。",
        "saveFailed": "保存失败，草稿已保留",
        "saveUnknown": "保存结果未确认，请重新读取核对，勿重复提交。",
        "mirrorWarning": "已保存，但备用副本未同步；请勿移除 SD 卡。",
        "revision_conflict": "配置已被其他操作修改，请重新读取后合并草稿。",
        "source_read_only": "此配置来源当前只读，未修改原文件。",
        "recovery_required": "配置需要恢复核对，自动执行已暂停。",
        "commit_unknown": "保存结果未确认，需要恢复核对。",
        "execution_busy": "规则正在执行，当前操作不可用。",
        "service_busy": "服务正在运行或状态未确认，请先核实并停止服务。",
        "busy_retired_config": "旧配置仍在使用，请稍后重试。",
        "disabled": "已禁用",
        "manual": "手动",
        "automatic": "自动",
        "referenceUnresolved": "引用尚未解析",
        "unknown": "状态未确认",
        "running": "进程运行中",
        "ready": "已匹配就绪日志",
        "checking": "正在检查就绪日志",
        ...
        "timeout": "就绪检查超时",
        "lastKnown": "上次状态",
        "confirmedAt": "上次确认（开机后）",
        "stateEvidence": "状态依据",
        "startBlocked": "当前不允许启动：请检查启用、手动权限及服务状态。",
        "outcomeUnknown": "远端结果未确认，可能仍在运行。请查询核实后再操作。",
        "confirmStop": "确认停止远端服务？",
        "confirmStopAutomatic": "确认停止远端服务？自动规则仍启用且条件满足时，下一次评估可能再次启动。若需保持停止，请先禁用自动规则。",
        "refresh_required": "页面版本过旧，请刷新后编辑。"
},
    ...
    system: {
        ...
        lpmuRunning: "网络可达",
        lpmuStopped: "网络不可达",
        lpmuOnlineTitle: "LPMU 网络可达；此检测不能确认电源状态。",
        lpmuOfflineTitle: "LPMU 网络不可达，无法据此确认是否已关机。",
        lpmuDetectingTitle: '正在检测 LPMU 状态...\n最多等待 80 秒',
        lpmuUnknownTitle: "LPMU 网络检测失败，电源状态未知。",
        ...
        lpmuOnlineSuccess: "LPMU 网络可达；此检测不能确认电源状态。",
        lpmuOfflineSuccess: "LPMU 网络不可达，无法据此确认是否已关机。",
        lpmuStartupTimeout: "LPMU 网络不可达，无法据此确认是否已关机。",
        lpmuShutdownTimeout: "LPMU 网络可达；此检测不能确认电源状态。"
    },
    ...
    toast: {
        ...
        lowVoltageWarning: "输入电压过低：{voltage} V，关机倒计时剩余 {countdown} 秒。",
        ...
        nohupStripped: "已移除重复的后台运行参数，系统会自动在后台执行此命令。",
        ...
        commandCompletedCode: "命令未成功完成，退出码：{code}。请查看命令输出。",
        execError: '执行出错',
        execErrorMsg: '执行出错: {msg}',
        commandCancelled: '取消处理已结束，远端结果未确认',
        hostFingerprintDeleted: '已删除主机指纹',
        hostInfoEmpty: "没有找到此主机的连接配置，请检查主机设置。",
    ...
    networkPage: {
        ...
        dhcpServer: 'DHCP 服务器',
        natGateway: 'NAT 网关',
        lpmuAccessTitle: '接入上层网络',
        lpmuAccessButton: '通过LPMU接入',
        lpmuAccessIdle: '未启动',
        lpmuAccessRunning: '处理中',
        lpmuAccessStageCheck: '检查远端项目',
        lpmuAccessStageUpload: '上传项目包',
        lpmuAccessStageUnpack: '解包项目',
        lpmuAccessStageExecute: '执行路由脚本',
        lpmuAccessSuccess: '成功',
        lpmuAccessFailed: '失败',
        lpmuAccessError: '错误',
        lpmuAccessOutput: '输出',
        lpmuAccessStartFailed: '启动接入失败',
        lpmuAccessStatusFailed: '状态获取失败',
        clients: '客户端',
        // 面板标题
    ...
    sshPage: {
        ...
        failMatchedTrue: "已检测到失败条件",
        failMatchedFalse: "未检测到失败条件",
    ...
    securityPage: {
        ...
        confirmAdminPassword: '确认新密码',
        confirmAdminPasswordPlaceholder: '再次输入新密码',
        showPassword: '显示密码',
        hidePassword: '隐藏密码',
        setAdminPassword: '设置 admin 新密码',
        dangerZone: '危险操作',
        resetAdminPasswordDesc: '将 admin 密码恢复为默认密码 rm01，并清除登录锁定状态。',
        resetAdminPassword: '重置 admin 为默认密码',
        adminPasswordMismatch: '两次输入的 admin 新密码不一致',
        adminPasswordLength: 'admin 密码长度必须为 4-64 个字符',
        adminPasswordSetSuccess: 'admin 密码已更新',
        adminPasswordResetSuccess: 'admin 密码已重置为默认密码 rm01',
        confirmResetAdminPassword: '确定要重置 admin 密码吗？\n\n此操作会将 admin 密码恢复为默认密码 rm01，并清除登录锁定状态。',
        // 证书详情
        subjectCN: '主体 CN',
        issuer: '签发者',
        notBefore: '生效时间',
    ...
    fanPage: {
        ...
        hysteresisRangeError: "调速温差（温度迟滞）必须在 0–20°C 范围内。",
        intervalRangeError: "两次调速的最小间隔必须在 0.5–30 秒之间。",
    ...
    pkiRepair: {
        ...
        "none": "未安装设备证书",
        "invalid": "证书无法解析",
        "time_unverified": "有效期：待校时确认",
        "not_yet_valid": "有效期：尚未生效",
        "valid": "有效期：当前在有效期内",
        "expired": "有效期：已过期",
        "stored": "已保存",
        "missing": "缺少",
        ...
        "running": "运行中",
        "stopped": "未运行",
        "restart": "存储材料已变更。运行中的服务仍使用旧材料；请重启设备以应用。新材料须满足启动条件，删除凭证不等于在线吊销。",
        "activeFingerprint": "活动证书 SHA-256",
        "deviceTime": "设备时间",
        "synced": "已同步",
        "unsynced": "未同步",
        "timeUnknown": "设备时间读取失败，请刷新重试",
        "syncBrowser": "用当前电脑时间校时（来源：浏览器）",
        "empty": "请输入 PEM 内容",
        "saved": "已保存，请查看有效期和 HTTPS 实际状态。",
        "unconfirmed": "未能确认安装结果，请刷新状态核对后再决定是否重试。",
        "lessDay": "不到 1 天后过期",
        "expiredLessDay": "已过期不足 1 天",
        "block_time_not_ready": "设备时间未就绪",
        "block_private_key_missing": "缺少私钥",
        "block_private_key_invalid": "私钥异常",
        "block_certificate_missing": "缺少设备证书",
        "block_certificate_invalid": "设备证书异常",
        "block_key_mismatch": "证书与密钥不匹配",
        "block_not_yet_valid": "证书尚未生效",
        "block_expired": "证书已过期",
        "block_ca_missing": "缺少客户端验证 CA",
        "block_ca_invalid": "客户端验证 CA 异常",
        "block_storage_error": "存储结果不确定，请重启后核对材料"
},
    pkiPage: {
        signatureVerified: '签名验证通过',
